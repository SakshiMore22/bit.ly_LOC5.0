...
$page='news';
 ...
 <div style="margin-left:16%;  width: 90%;">
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add Opportunities</li>
        </ul>       
       </div>

  <div style=" width: 80%; margin-left: 20%; margin-top: 1%;margin-bottom: 1%">
  	    <div class="text-right">
  	    <a class="btn btn-primary" href="AddNews.php">Add Opening</a> 
